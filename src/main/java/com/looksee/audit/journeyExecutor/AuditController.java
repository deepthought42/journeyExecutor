package com.looksee.audit.journeyExecutor;
...
import com.looksee.audit.journeyExecutor.models.message.VerifiedJourneyMessage;
import com.looksee.audit.journeyExecutor.models.message.DiscardedJourneyMessage;
import com.looksee.audit.journeyExecutor.models.message.JourneyMessage;
import com.looksee.audit.journeyExecutor.services.AuditRecordService;
import com.looksee.audit.journeyExecutor.services.BrowserService;
import com.looksee.audit.journeyExecutor.gcp.PubSubAuditRecordPublisherImpl;
import com.looksee.audit.journeyExecutor.gcp.PubSubErrorPublisherImpl;
import com.looksee.audit.journeyExecutor.mapper.Body;
import com.looksee.audit.journeyExecutor.models.Browser;
import com.looksee.audit.journeyExecutor.models.Domain;
...
import com.looksee.audit.journeyExecutor.services.DomainService;
import com.looksee.audit.journeyExecutor.services.PageStateService;
...
public class AuditController {
	...
	{	
		JourneyMessage journey_msg = (JourneyMessage)body.getMessage();
	    ...
	    JourneyMessage journey_msg = objectMapper.readValue(decoded_json, JourneyMessage.class);
	     */
	...
	private void processIfStepsShouldBeExpanded(long journey_id, 
												...
												long domain_id, 
												long account_id, 
												long audit_record_id ) throws JsonProcessingException, ExecutionException, InterruptedException 
	{
		try {
