package com.looksee.audit.journeyExecutor.services;
...
import com.looksee.audit.journeyExecutor.gcp.CloudVisionUtils;
import com.looksee.audit.journeyExecutor.gcp.GoogleCloudStorage;
import com.looksee.audit.journeyExecutor.gcp.ImageSafeSearchAnnotation;
import com.looksee.audit.journeyExecutor.models.Browser;
import com.looksee.audit.journeyExecutor.models.BrowserConnectionHelper;
...
import com.looksee.audit.journeyExecutor.models.ImageFaceAnnotation;
import com.looksee.audit.journeyExecutor.models.ImageLandmarkInfo;
import com.looksee.audit.journeyExecutor.models.ImageSearchAnnotation;
import com.looksee.audit.journeyExecutor.models.Label;
import com.looksee.audit.journeyExecutor.models.Logo;
import com.looksee.audit.journeyExecutor.models.PageState;
import com.looksee.audit.journeyExecutor.models.Template;
...
import com.looksee.audit.journeyExecutor.models.enums.ElementClassification;
import com.looksee.audit.journeyExecutor.models.enums.TemplateType;
...
public class BrowserService {
	...
	public Map<String, Template> findTemplates(List<com.looksee.audit.journeyExecutor.models.Element> element_list){
		//create a map for the various duplicate elements
		Map<String, Template> element_templates = new HashMap<>();
		List<com.looksee.audit.journeyExecutor.models.Element> parents_only_element_list = new ArrayList<>();
		for(com.looksee.audit.journeyExecutor.models.Element element : element_list) {
			if(!element.isLeaf()) {
		...
		for(int idx1 = 0; idx1 < parents_only_element_list.size()-1; idx1++){
			com.looksee.audit.journeyExecutor.models.Element element1 = parents_only_element_list.get(idx1);
			...
			for(int idx2 = idx1+1; idx2 < parents_only_element_list.size(); idx2++){
				com.looksee.audit.journeyExecutor.models.Element element2 = parents_only_element_list.get(idx2);
