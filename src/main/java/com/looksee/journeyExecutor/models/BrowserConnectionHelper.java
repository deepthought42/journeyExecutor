...
public class BrowserConnectionHelper {
	...
	private static final String[] RESOURCE_HEAVY_REQUEST_HUB_IP_ADDRESS = {"selenium-chrome-uydih6tjpa-uc.a.run.app", "selenium-standalone-2-uydih6tjpa-uc.a.run.app"};
